#ifndef _CYCLE_P_LAST_MODEL_DELEGATE_H_
#define _CYCLE_P_LAST_MODEL_DELEGATE_H_

#include <QObject>
#include <QAbstractTableModel>
#include <QItemDelegate>

class CyClePLastModelItem : public QObject
{
    Q_OBJECT
public:
    CyClePLastModelItem(QObject* parent = nullptr);
    ~CyClePLastModelItem();
    ...
    inline QString Get_HName() {return PName;}
    inline QString Get_HValue() {return PValue;}
...
class CyClePLastTableModel: public QAbstractTableModel
{
    Q_OBJECT
public:
    CyClePLastTableModel();
    ~CyClePLastTableModel();
    ...
    void RefrushModel(CyClePLastModelItem*);
...
private:
    ...
    QList<CyClePLastModelItem*>* Ary_row_List;
    QString Get_Name = "";
    QString Get_FirstValue = "";
    QString Get_SecondValue = "";
    const int mTableMaxNum = 200;
};

class CyClePLastTableDelegate : public QItemDelegate
{
    Q_OBJECT
public:
    explicit CyClePLastTableDelegate(QObject *parent = nullptr);
    virtual ~CyClePLastTableDelegate();
