#ifndef _CYCLE_P_MORE_MODEL_DELEGATE_H_
#define _CYCLE_P_MORE_MODEL_DELEGATE_H_

#include <QObject>
#include <QAbstractTableModel>
#include <QItemDelegate>

class CyClePMoreModelItem : public QObject
{
    Q_OBJECT
public:
    CyClePMoreModelItem(QObject* parent = nullptr);
    ~CyClePMoreModelItem();
...
class CyClePMoreTableModel: public QAbstractTableModel
{
    Q_OBJECT
public:
    CyClePMoreTableModel();
    ~CyClePMoreTableModel();
    ...
    void RefrushModel(CyClePMoreModelItem*);
...
private:
    ...
    QList<CyClePMoreModelItem*>* Ary_row_List;
    QString Get_Name = "";
    QString Get_FirstValue = "";
    QString Get_SecondValue = "";
};

class CyClePMoreTableDelegate : public QItemDelegate
{
    Q_OBJECT
public:
    explicit CyClePMoreTableDelegate(QObject *parent = nullptr);
    virtual ~CyClePMoreTableDelegate();
