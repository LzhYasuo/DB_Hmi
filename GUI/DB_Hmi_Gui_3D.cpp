...
//    mWidget->setStyleSheet("background-color:rgb(0,0,0);");
...
//    connect(glWidget ,SIGNAL(nowOpenedFileMsg(QString )),this,SLOT(getMsg(QString) ));
    ...
    connect(glWidget,&GLWidget::AddSpeed,_theVScreen,&VScreen::Slot_Add_Speed);
    connect(glWidget,&GLWidget::SubSpeed,_theVScreen,&VScreen::Slot_Sub_Speed);
